...
box_lower = board_cellsize * np.array([[8, 5,  0], [9, 5,  0], [9, 3,  0], [8, 3,  0],[8,2,0],[7,2,0],[7,3,0],[6,3,0],[6,5,0],[7,5,0],[7,4,0],[8,4,0]])
box_upper = board_cellsize * np.array([[2, 2, 0], [5, 2, 0],[5, 5, 0],[4,5,0],[4,3,0] ,[4,5,0],[3,5,0],[3,3,0],[3,5,0], [2, 5, 0]])
